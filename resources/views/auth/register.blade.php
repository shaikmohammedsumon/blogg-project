                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{route('register')}}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" type="text" id="name"  placeholder="Enter your Name" name="name"  value="{{ old('name') }}">
                            ...
                            <div class="form-group mb-3">
                                <a class='text-muted float-end' href='pages-recoverpw.html'><small></small></a>
                                <label class="form-label" for="password">Password</label>
                                <input class="form-control  @error('password') is-invalid @enderror" type="password"  id="password" placeholder="Enter your password" name="password_confirmation"  value="{{ old('password_confirmation') }}">
