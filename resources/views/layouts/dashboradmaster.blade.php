...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/7fty8d891jnxzu9pwuuak70kqighlodrtn695ffoo7tixzaa/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
        ...
        <div class="main-menu">
            ...
            <div data-simplebar>
                <ul class="app-menu">
                    ...
                    <li class="menu-title"> Management Role & Permation</li>

                        <li class="menu-item">
                            <a href="#Management" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                                <span class="menu-icon"><i class="bx bx-file"></i></span>
                                <span class="menu-text">Role & Permation</span>
                                ...
                                <ul class="sub-menu">
                                    <li class="menu-item">
                                        <a class='menu-link' href='{{route('management.index')}}'>
                                            <span class="menu-text">Assign Role & Permation</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item">
                            <a href="#Blogger" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                                <span class="menu-icon"><i class="bx bx-file"></i></span>
                                <span class="menu-text">Blogger Request</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="Blogger">
                                <ul class="sub-menu">
                                    <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="#Abouts" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                                <span class="menu-icon"><i class="bx bx-file"></i></span>
                                <span class="menu-text">Frontend Controles </span>
                                <span class="menu-arrow"></span>
                            </a>
                            ...
                            <div class="collapse" id="Abouts">
                                <ul class="sub-menu">
                                    <li class="menu-item">
                                        <a class='menu-link' href='{{route('dashboard.abouts.index')}}'>
                                            <span class="menu-text">Created Abouts</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a class='menu-link' href='{{route('dashboard.abouts.show')}}'>
                                            <span class="menu-text">Show Abouts</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a class='menu-link' href='{{route('contract')}}'>
                                            <span class="menu-text">Contract Massege</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a class='menu-link' href='{{route('connected.index')}}'>
                                            <span class="menu-text">Show Connected</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <li class="menu-item">
                        <a href="#menucategories" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                            <span class="menu-icon"><i class="bx bx-file"></i></span>
                    ...
                    <li class="menu-item">
                        <a href="#blogPage" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                            <span class="menu-icon"><i class="bx bx-file"></i></span>
                            <span class="menu-text"> Blog </span>
                            <span class="menu-arrow"></span>
                        </a>
                        <div class="collapse" id="blogPage">
                            <ul class="sub-menu">
                                <li class="menu-item">
                    ...
                    <ul class="topbar-menu d-flex align-items-center gap-4">
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                ...
                                <img src="{{asset('uploads/profile_default')}}/{{auth()->user()->image}}" alt="user-image" class="rounded-circle">
                                @else
